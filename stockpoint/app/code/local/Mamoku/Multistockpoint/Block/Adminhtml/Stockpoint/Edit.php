...
class Mamoku_Multistockpoint_Block_Adminhtml_Stockpoint_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
		...
		{
				if( Mage::registry("stockpoint_data") && Mage::registry("stockpoint_data")->getId() ){

				    return Mage::helper("multistockpoint")->__("Edit Item '%s'", $this->htmlEscape(Mage::registry("stockpoint_data")->getId()));
