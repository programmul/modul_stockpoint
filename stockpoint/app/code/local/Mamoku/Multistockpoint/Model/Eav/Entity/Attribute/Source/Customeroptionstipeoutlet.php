<?php
class Mamoku_Multistockpoint_Model_Eav_Entity_Attribute_Source_Customeroptionstipeoutlet extends Mage_Eav_Model_Entity_Attribute_Source_Abstract
{
  protected $_options = null;

    function getAllOptions($withEmpty = false){
        $attribute = Mage::getModel('eav/config')->getAttribute('customer','tipe_outlet');
