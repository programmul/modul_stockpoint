...
class Mamoku_PaymentConfirmation_Adminhtml_ConfirmationController extends Mage_Adminhtml_Controller_Action
{
    ...
    public function pendingAction()
    {
        if($this->_isAllowed()){
            $this->_initAction();
            $this->_addContent($this->getLayout()->createBlock('paymentconfirmation/adminhtml_confirmation'));
            $this->renderLayout();
        }
    }
    ...
    public function editAction()
    {
        if($this->_isAllowed()){
            ...
            $this->_addContent($this->getLayout()->createBlock('paymentconfirmation/adminhtml_confirmation_edit'))
                    ->_addLeft($this->getLayout()->createBlock('paymentconfirmation/adminhtml_confirmation_edit_tabs'));
