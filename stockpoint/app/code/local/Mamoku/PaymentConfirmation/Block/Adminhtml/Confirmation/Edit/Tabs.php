...
class Mamoku_PaymentConfirmation_Block_Adminhtml_Confirmation_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
    ...
    protected function _beforeToHtml()
    {
        ...
        $this->addTab('confirmation_section', array(
            ...
            'content'   => $this->getLayout()->createBlock('paymentconfirmation/adminhtml_confirmation_edit_tab_confirmation')->toHtml()
        ));
