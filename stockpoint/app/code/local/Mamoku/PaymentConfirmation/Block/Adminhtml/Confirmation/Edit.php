...
class Mamoku_PaymentConfirmation_Block_Adminhtml_Confirmation_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    public function __construct()
    {
        ...
        $this->_headerText = Mage::helper('paymentconfirmation')->__('Confirmation Data');
