...
class Mamoku_PaymentConfirmation_Block_Adminhtml_Confirmation extends Mage_Adminhtml_Block_Widget_Grid_Container {
    ...
    protected function _prepareLayout() {
        ...
        $this->setChild('grid', $this->getLayout()->createBlock('paymentconfirmation/adminhtml_confirmation_grid', 'confirmation.grid'));
    ...
    public function getHeaderText()
    {
        ...
        {
            return Mage::helper('paymentconfirmation')->__('Pending Confirmations');
        }
        elseif( $pageAction == 'all') 
        {
            return Mage::helper('paymentconfirmation')->__('All Confirmations');
        }
    }
